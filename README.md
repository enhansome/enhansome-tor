...
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,819 | 🐛 7 | 🌐 Python | 📅 2026-09-04 - Python web crawler for Dark and Deep Web. Actively maintained and can be used in Docker container (dockerfile provided).
...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,647 | 🐛 6 | 🌐 Go | 📅 2026-09-07 - DNS proxy server supporting arbitrary DNS, DNSCrypt v2, DNS-over-TLS, and DNS-over-HTTPS queries that can be torified with a two-line configuration change (`force_tcp = true` and `proxy = socks5://127.0.0.1:9050` or similar).
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,881 | 🐛 461 | 🌐 Python | 📅 2026-09-08 - Open-source whistleblower submission system that media organizations can use to securely accept documents from and communicate with anonymous sources.
