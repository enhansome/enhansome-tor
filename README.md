...
* [Tor Onion Proxy Library](https://github.com/thaliproject/Tor_Onion_Proxy_Library) ⭐ 185 | 🐛 44 | 🌐 Java | 📅 2024-06-09 - Provides a JAR and an AAR for embedding a Tor Onion service proxy into a Java or Android program.
...
* [Tor.framework](https://github.com/iCepa/Tor.framework) ⭐ 257 | 🐛 7 | 🌐 Objective-C | 📅 2026-08-11 - The easiest way to embed Tor in your iOS application.
...
* [Connecting to an authenticated Onion service](https://github.com/AnarchoTechNYC/meta/wiki/Connecting-to-an-authenticated-Onion-service) ⭐ 511 | 🐛 1 | 🌐 HTML | 📅 2025-08-17 - Guided procedure written for laypeople describing how to configure a Tor client to connect to authenticated Onion services.
...
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,799 | 🐛 7 | 🌐 Python | 📅 2026-09-04 - Python web crawler for Dark and Deep Web. Actively maintained and can be used in Docker container (dockerfile provided).
...
* [Tor Controller (for Kubernetes)](https://github.com/kragniz/tor-controller) ⭐ 532 | 🐛 10 | 🌐 Go | 📅 2021-09-26 - Expose applications deployed in Kubernetes clusters via Tor Onion services.
...
* [Offensive Tor Toolkit](https://github.com/atorrescogollo/offensive-tor-toolkit) ⭐ 65 | 🐛 1 | 🌐 Go | 📅 2021-07-03 - Series of tools written in Go that simplify the use of Tor for typical exploitation and post-exploitation tasks.
...
* [ansible-relayor](https://github.com/nusenu/ansible-relayor) ⭐ 257 | 🐛 7 | 🌐 HTML | 📅 2026-06-01 - An Ansible role for Tor Relay Operators.
...
* [Bine](https://github.com/cretz/bine) ⭐ 825 | 🐛 27 | 🌐 Go | 📅 2023-07-28 - Go library for accessing and embedding Tor clients and servers.
...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,640 | 🐛 8 | 🌐 Go | 📅 2026-09-03 - DNS proxy server supporting arbitrary DNS, DNSCrypt v2, DNS-over-TLS, and DNS-over-HTTPS queries that can be torified with a two-line configuration change (`force_tcp = true` and `proxy = socks5://127.0.0.1:9050` or similar).
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,881 | 🐛 461 | 🌐 Python | 📅 2026-09-06 - Open-source whistleblower submission system that media organizations can use to securely accept documents from and communicate with anonymous sources.
