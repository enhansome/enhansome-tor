...
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,637 | 🐛 8 | 🌐 Python | 📅 2026-07-28 - Python web crawler for Dark and Deep Web. Actively maintained and can be used in Docker container (dockerfile provided).
...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,585 | 🐛 12 | 🌐 Go | 📅 2026-08-17 - DNS proxy server supporting arbitrary DNS, DNSCrypt v2, DNS-over-TLS, and DNS-over-HTTPS queries that can be torified with a two-line configuration change (`force_tcp = true` and `proxy = socks5://127.0.0.1:9050` or similar).
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,874 | 🐛 459 | 🌐 Python | 📅 2026-08-19 - Open-source whistleblower submission system that media organizations can use to securely accept documents from and communicate with anonymous sources.
